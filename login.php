...
<head>
    <meta charset="UTF-8">
    <title>RGUArtist - Login Page</title>
    <link rel="stylesheet" type="text/css" href="Resources/CSS/styleSheet.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Rakkas|Quicksand">

</head>
<body>
    <form action="LogintoRGUArtist.php" method="post">
        <main>
           <div class="bg">
           <br/>
           ...
           <h2>Welcome to RGU Artist</h2>
               <input type="matriculationNumber" name="matriculationNumber" placeholder="Matriculation Number" onfocus="this.placeholder=''" onblur="this.placeholder='Matriculation Number'" required><br>
